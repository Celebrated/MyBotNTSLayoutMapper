...
Global $aAlwaysEnabledControls[19] = [$chkUpdatingWhenMinimized, $chkHideWhenMinimized, $chkDebugClick, $chkDebugSetlog, $chkDebugOcr, $chkDebugImageSave, $chkdebugBuildingPos, $chkdebugTrain, $chkdebugOCRDonate, $btnTestTrain, $btnTestDonateCC, $btnTestAttackBar, $btnTestClickDrag, $btnTestImage, $btnEagle, $btnImageFolder, $btnEQDeploy, $btnDropS, $btnTestAD]
...
Func Bind_ImageList($nCtrl)
	...
	Switch $nCtrl
		...
		Case $hGUI_ARMY_TAB
			...
			Local $aIconIndex[5] = [$eIcnBarbarian, $eIcnLightSpell, $eIcnGem, $eIcnOptions, $eIcnCamp]
